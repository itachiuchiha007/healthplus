 ...
 * {@link ReportHistoryFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ReportHistoryFragment#newInstance} factory method to
...
public class ReportHistoryFragment extends Fragment {
    ...
    public static ReportHistoryFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_report_history, container, false);


        JSONObject object = new JSONObject();
        try {
            object.put("patient_id","P02");
